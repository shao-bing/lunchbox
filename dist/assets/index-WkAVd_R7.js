...
function ResultModal({ isOpen, result, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass relative w-full max-w-sm overflow-hidden rounded-3xl p-6 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm tracking-[0.28em] text-cyan-300", children: "今日天选午餐" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative mt-3 text-3xl font-black text-slate-100 neon-text", children: result }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onClose,
...
function Wheel({ items, rotation, isSpinning, onStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-80 w-80 select-none sm:h-96 sm:w-96", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-0 z-20 h-0 w-0 -translate-x-1/2 border-l-[16px] border-r-[16px] border-b-[28px] border-l-transparent border-r-transparent border-b-cyan-300 drop-shadow-[0_0_14px_rgba(34,211,238,0.8)]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 z-10 h-9 w-9 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-cyan-100/80 bg-slate-900 shadow-[0_0_14px_rgba(34,211,238,0.45)]" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    items.length < 2 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-slate-400", children: "至少添加 2 个选项才可以开始。" })
  ] });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-10 sm:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "relative z-10 mb-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "inline-flex items-center rounded-full border border-cyan-400/40 bg-cyan-400/10 px-3 py-1 text-xs font-semibold tracking-[0.2em] text-cyan-200", children: "午餐决策器" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "neon-text mt-4 text-4xl font-black tracking-tight text-slate-100 sm:text-5xl", children: "今天中午吃什么" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-slate-300", children: "加入你想吃的选项，转动命运之轮，一键决定午餐。" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 grid flex-1 gap-8 lg:grid-cols-[1fr_340px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `glass rounded-3xl p-6 ${isWheelFlash ? "wheel-stop-flash" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Wheel,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "glass rounded-3xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-slate-100", children: "午餐选项" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-4 space-y-2", children: normalizedItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
            className: "flex items-center justify-between rounded-xl border border-slate-700/60 bg-slate-950/75 px-3 py-2",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-slate-200", children: item }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
        ...
        !normalizedItems.length && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-slate-400", children: "还没有选项，先添加几种想吃的吧。" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AddFoodModal,
